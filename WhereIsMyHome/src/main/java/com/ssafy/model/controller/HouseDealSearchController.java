...
public class HouseDealSearchController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String dealYear = request.getParameter("searchYear");

        System.out.println("검색: " + searchKeyword);
        // 데이터 조회
        List<HouseDeal> houseDeals = houseDealService.searchListByKeyword(searchKeyword, dealYear);
